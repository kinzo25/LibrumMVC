        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Agatha Christie", "A group of passengers trapped on the Orient Express in a snow storm with a murdered body and a Belgian detective to keep them school: Murder on the Orient Express is one of Agatha Christie’s most famous stories. It's an intricate mystery revolving around a group of characters cut off from the world where Poirot exhibits not only the power of his little grey cells but his concern and compassion for humanity.", "MOOE5038", 12.49, 9.9900000000000002, 8.4900000000000002, "Murder on the Orient Express" },
